...
$PYTHON_CMD ${SOURCE_DIR}/main.py \
	...
	train.num_epochs=20 \
	model/decoder/deformable=ConditionedDCNv2 \
	model.decoder.deformable.version=XYZConditionedDCNv2 \
	model.decoder.deformable.layers=[rf2,rf3] \
	model.decoder.deformable.size_activation=relu_plus_one \
